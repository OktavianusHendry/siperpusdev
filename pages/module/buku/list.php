<div id="frame-tambah">
    <a href="<?php echo BASE_URL."index.php?page=my_perpus&module=buku&action=form"; ?>" class="tombol">+ Tambah Buku</a>
</div>
    ...
    if(mysqli_num_rows($queryBuku)==0){
        ...
        while($row=mysqli_fetch_assoc($queryBuku)){
            ...
            echo "<tr>
                    ...
                    <td>
                        <a class='tombol' href='".BASE_URL."index.php?page=my_perpus&module=buku&action=form&kode_buku=$row[kode_buku]&inisial_nama_belakang=$row[inisial_nama_belakang]&huruf_depan_judul=$row[huruf_depan_judul]'>Edit</a>
                    </tr>";
        }
    }
?>